...
def main():
    ...
    final_heatmap = np.vstack([neutral_heatmap, positive_first, positive_second])
    ...
    # 保存
    output_path = os.path.join(output_dir, "F2_heatmap_45x68_v6.png")
